...
/**
 * Represents the configuration for a food item that provides regeneration effects.
 * This includes health, ki, and stamina regeneration values.
 */
public class FoodConfig {
    ...
    /**
     * Builder class for creating instances of {@link FoodConfig}.
     * Use the builder to fluently set values before building the final object.
     */
