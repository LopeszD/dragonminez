...
public class ServerStatManager extends StatManager {
  ...
  public void setRace(Player player, String raceIdentifier, boolean log) {
    this.setStatInternal(player, StatType.RACE, raceIdentifier,
        data -> data.setRace(raceIdentifier), log);
  }
  ...
  public void setForm(Player player, String formIdentifier, boolean log) {
    this.setStatInternal(player, StatType.FORM, formIdentifier,
        data -> data.setForm(formIdentifier), log);
  }
  ...
  public void setBlocking(Player player, boolean blocking, boolean log) {
    this.setStatInternal(player, StatType.BLOCKING, blocking, data ->
        data.setBlocking(blocking), log);
  }

  private void setStatInternal(Player player, StatType type, Object value,
      Consumer<StatData> dataConsumer, boolean log) {
