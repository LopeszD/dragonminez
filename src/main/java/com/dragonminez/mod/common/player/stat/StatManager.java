...
/**
 * Central manager for accessing and updating {@link StatData} on players via Forge's capability system.
 * <p>
 * Serves as a common superclass for both client- and server-specific stat managers.
 * Intended to be accessed statically via {@link StatManager#INSTANCE}.
 */
public class StatManager implements ICapabilityProvider {
    ...
    /**
     * Updates a player's {@link StatData} by overwriting it with the contents of another {@link StatData} instance.
     *
    ...
    /**
     * Provides the {@link StatData} capability implementation to the capability system.
     * This method is part of Forge's {@link ICapabilityProvider} interface.
     *
